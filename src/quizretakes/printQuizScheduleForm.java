...
//		long diff = Math.abs(duration.toDays());
	...
	protected void printDataForAdmin(HttpServletRequest req, HttpServletResponse resp, String msg,  Boolean isAuthenticated )
...
//		req.setAttribute("quizzesMap", quizzesMap); //old way for admin.jsp
		...
		dispatcher.forward(req, resp);}
		    	...
		    	RequestDispatcher dispatcher = req.getRequestDispatcher("/instructor.jsp");
		    	dispatcher.forward(req, resp);
		    }
