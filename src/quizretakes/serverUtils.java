...
public class serverUtils {
	// Data files
		...
		private static final String packageName = "quizretakes";
		...
		public static String getDir()  {
			...
			if(env.equals("local")) {
//				if(packageName!="")
//				path=home+File.separator+"eclipse-workspace"+File.separator+projectName+File.separator+"src"+File.separator+packageName+File.separator;
//				else
